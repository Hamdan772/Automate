...
export const DEBUGGER_ATTACH_CONFLICT_ERROR = `Failed to attach debugger.
  This is likely due to conflicting extensions. Please use Automate in a new profile.`;

// Alias for backward compatibility
export const EXTENSION_CONFLICT_ERROR_MESSAGE = DEBUGGER_ATTACH_CONFLICT_ERROR;
